 ...
 */
export default function useOnAction({ router, getState, setState, key, listeners, routerConfigOptions, }: Options): (action: any, visitedNavigators?: Set<string>) => boolean;
export {};
